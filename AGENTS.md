...
This file contains essential information for AI assistants (like Codex) working on the Kite monorepo. It provides quick context, project structure, and pointers to detailed documentation.
